...
import com.mdm.api.rest.EnrollmentHandler;
...
public class EnrollmentHandlerTest extends JerseyTest {
	private static final String BC = BouncyCastleProvider.PROVIDER_NAME;
	private AwsCertificateAuthorityStore store = null;
	...
	public void setUp() throws Exception {
		...
		store = new AwsCertificateAuthorityStore();
		parentId = Long.toString(Calendar.getInstance().getTimeInMillis(), 32);
    ...
    protected Application configure() {
        ...
        return new ResourceConfig(EnrollmentHandler.class);
    }
