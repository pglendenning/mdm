...
public final class HashRootCertificateAuthorityConnector implements 
			IRootCertificateAuthorityConnector {
	private HashRootCertificateAuthorityStore store;
	...
	public HashRootCertificateAuthorityConnector(HashRootCertificateAuthorityStore store,
						X509Certificate ca, X509Certificate ra,
						PrivateKey raKey, boolean enabled, String objectId) {
		this.store = store;
		this.caCert = ca;
		this.raCert = ra;
